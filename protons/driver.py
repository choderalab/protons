...
class _BaseProtonDrive(_BaseDrive):
    ...
    def _attempt_state_change(self, context, residue_pool=None, reject_on_nan=False):
        ...
        if self.maintainChargeNeutrality:
            ...
            raise NotImplementedError('maintainChargeNeutrality feature not yet supported')
        ...
        try:
            ...
            self.last_proposal[self._attempt_number] = (initial_titration_states, final_titration_states, work)
            log_P_accept = -work
