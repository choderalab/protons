...
xmltree = etree.parse("amber10-constph-tmp.xml", etree.XMLParser(remove_blank_text=True, remove_comments=True))
...
with open('bonds-amber10-constph-tmp.xml', 'w') as fstream:
