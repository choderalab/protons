...
Feature: Building the forcefield files
  ...
  Scenario: Compiling raw ffxml for constant-pH residues from amber source files
    ...
    Given the directory "Amber_input_files" exists
  ...
  Scenario: Processing raw parmed output
    Given I use the current directory as working directory
    Given the directory "Amber_input_files" exists
    Given a file named "Amber_input_files/raw-protons.xml" exists
  ...
  Scenario: Generating hydrogen definitions
    Given I use the current directory as working directory
    Given the directory "Amber_input_files" exists
    Given a file named "protons.xml" exists
  ...
  Scenario: Compiling raw ffxml for amber ion parameters from amber source files
    Given I use the current directory as working directory
    Given the directory "Amber_input_files/ions" exists
    ...
    Then a temporary file named "raw_ions_tip3p-tmp.xml" should exist in the directory "Amber_input_files/ions"
    Then a temporary file named "raw_ions_tip4pew-tmp.xml" should exist in the directory "Amber_input_files/ions"

  Scenario: Compiling raw ffxml for amber ion parameters from amber source files
    Given I use the current directory as working directory
    Given the directory "Amber_input_files/ions" exists
    Given a file named "Amber_input_files/ions/raw_ions_spce.xml" exists
    Given a file named "Amber_input_files/ions/raw_ions_tip3p.xml" exists
    Given a file named "Amber_input_files/ions/raw_ions_tip4pew.xml" exists
