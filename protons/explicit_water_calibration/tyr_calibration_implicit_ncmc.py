...
# Create system
directory = '/cbio/jclab/home/rossg/protons/protons/tests/testsystems/tyr_implicit/'
filename = 'sams_implicit_ncmc.pickle'
...
simulation, driver, sams_sampler, integrator = load_tyrosine_implicit(directory,platform='OpenCL', nsteps=10)
