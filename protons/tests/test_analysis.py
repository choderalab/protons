...
class TestBARforSAMS:
    ...
    def test_bar_on_pregenerated_netcdf(self):
        ...
        with netCDF4.Dataset(self.a1, 'r') as dataset:
            ...
            assert len(output) == 3, "There should be three free energy differences in the output."
...
class TestMultifileAnalysis:
    ...
    def test_multiple_files(self):
        ...
        datasets = [netCDF4.Dataset(filename, 'r') for filename in [self.a1,self.a2,self.a3]]
