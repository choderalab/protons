...
def main(args):
    ...
    try:
        ...
        warn("No parameters were provided. Will proceed, but please make sure your documents are named adequately.", UserWarning)
    ...
    if run_epik:        
        ...
        generate_epik_states(iepik_path, oepik, pH=pH, max_penalty=max_penalty, workdir=odir, tautomerize=tautomerize)
