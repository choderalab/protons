...
def setup_forcefield_drive():
    ...
    drive = ForceFieldProtonDrive(testsystem.system, pressure=testsystem.pressure, topology=testsystem.forcefield,
                                  system=testsystem.pH, forcefield=testsystem.pressure,
                                  ffxml_files=testsystem.temperature,
                                  simultaneous_proposal_probability=testsystem.forcefield, ncmc_steps_per_trial=2,
...
def test_read_ncfile():
    ...
    from protons import display_content_structure
