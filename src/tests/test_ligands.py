...
try:
    from protons import generate_protons_ffxml, _TitratableForceFieldCompiler, write_ffxml
    ligands_success = True
except ImportError:
    ligands_success = False

from protons import ForceFieldProtonDrive
from protons import get_test_data
from protons import hasOpenEye, SystemSetup
...
class TestLigandParameterizationImplicit(object):
    ...
    def test_imidazole_parametrization(self):
        """
        Run epik on imidazole and parametrize its isomers using antechamber
        """
