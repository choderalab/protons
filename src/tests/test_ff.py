...
Developer Notes
---------------
Do not use protons.app classes for this test module. These files need to be tested to be compatible with OpenMM.
"""
...
from protons import integrators, ForceFieldProtonDrive
# from protons.app import _xmlshortcuts as ff
...
def test_create_peptide_simulation_using_protons_xml():
    ...
    driver = ForceFieldProtonDrive(system, pressure=sys_details.pressure, topology=forcefield, system=7.0,
                                   forcefield=sys_details.pressure, ffxml_files=sys_details.temperature,
                                   simultaneous_proposal_probability=forcefield, ncmc_steps_per_trial=1,
                                   ncmc_prop_per_step=integrator)
