...
from protons.proposals import _StateProposal
...
class NCMCProtonDrive(_BaseDrive):
    """
    The NCMCProtonDrive is an abstract base class Monte Carlo driver for protonation state changes and tautomerism in OpenMM.
    ...
    """
    def __init__(self, temperature, pressure, topology, system, ncmc_steps_per_trial=0):
        """
        ...
        * Generalize simultaneous_proposal_probability to allow probability of single, double, triple, etc. proposals to be specified?
        ...
        self.ncmc_stats_per_step = [[None] * ncmc_steps_per_trial]
        ...
        try:
            ...
            if self.nsteps_per_trial == 0:
                ...
                if initial_titration_states != final_titration_states:
                    ...
                    work = 0.0
                    for step in range(self.nsteps_per_trial):
                        self.ncmc_stats_per_step[self._attempt_number][step] = (0.0, 0.0, 0.0)
    ...
    def _get_potential_energy(self, state_index, group_index=0):
        ...
        self._set_titration_state(group_index, state_index)
...
class AmberProtonDrive(NCMCProtonDrive):
    ...
    """
    def __init__(self, temperature, pressure, topology, system, cpin_filename,
        ...
        * Generalize simultaneous_proposal_probability to allow probability of single, double, triple, etc. proposals to be specified?
        ...
        super(AmberProtonDrive, self).__init__(temperature, pressure, topology, system, ncmc_steps_per_trial=ncmc_steps_per_trial)
...
class ForceFieldProtonDrive(NCMCProtonDrive):
    ...
    def __init__(self, temperature, pressure, topology, system, forcefield, ffxml_files, ncmc_steps_per_trial=0, residues_by_name=None, residues_by_index=None):
        ...
        * Generalize simultaneous_proposal_probability to allow probability of single, double, triple, etc. proposals to be specified?
        ...
        super(ForceFieldProtonDrive, self).__init__(topology, system, temperature, pressure, ncmc_steps_per_trial=ncmc_steps_per_trial)
    ...
    def _parse_ffxml_files(self, ffxml_files):
        ...
        for file in ffxml_files:
            try:
                ...
                tree = etree.parse(os.path.join(os.path.dirname(__file__), 'app/data', file))
